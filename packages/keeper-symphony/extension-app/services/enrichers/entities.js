  ...
  NOTIFICATION: {
    ...
    json: {
      ...
      content: {
        ...
        body:
          "The BDK comes with ready-to-use message templates that you can use to render messages with your own data. You can add you own templates using the extension application.",
      },
      showStatusBar: true,
      comment: {
        body: "so interesting!",
