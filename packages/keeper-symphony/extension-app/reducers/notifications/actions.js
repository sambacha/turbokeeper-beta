...
export function getNotifications() {
  return (dispatch) => {
    ...
    return RestClient.get(ROOT_URL)
      ...
      .catch((error) =>
        dispatch({type: GET_NOTIFICATIONS_FAILURE, payload: error.data})
      );
  };
}
...
export function postNotification(notification) {
  return (dispatch) => {
    ...
    return RestClient.post(ROOT_URL, {
      ...
      .catch((error) =>
        dispatch({type: POST_NOTIFICATION_FAILURE, payload: error.data})
      );
  };
}
...
export function deleteNotification(notificationId) {
  return (dispatch) => {
    ...
    return RestClient.delete(`${ROOT_URL}/${notificationId}`)
      ...
      .catch((error) =>
        dispatch({type: DELETE_NOTIFICATIONS_FAILURE, payload: error.data})
      );
  };
}
...
export function editNotification(notification) {
  return (dispatch) => {
    ...
    return RestClient.put(`${ROOT_URL}/${notification.id}`, {
      ...
      .catch((error) =>
        dispatch({type: PUT_NOTIFICATION_FAILURE, payload: error.data})
      );
  };
}
