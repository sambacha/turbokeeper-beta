    ...
    try {
      prompt.ask(async (answer) => {
        if (answer) {
          ...
          console.log(
            `ycrvContract.setStrategist(${crvStrategyKeep3r.address})`
          );
          console.log(
            `busdContract.setStrategist(${crvStrategyKeep3r.address})`
          );
          console.log(
            `sbtcContract.setStrategist(${crvStrategyKeep3r.address})`
          );
          console.log(
            `pool3Contract.setStrategist(${crvStrategyKeep3r.address})`
          );
