    ...
    ICrvStrategyKeep3r
{
    ...
    // Setters
    function addStrategy(address _strategy, uint256 _requiredHarvest)
        external
        override
        onlyGovernor
    {
    ...
    function updateRequiredHarvestAmount(
        address _strategy,
    ...
    function _setRequiredHarvest(address _strategy, uint256 _requiredHarvest)
        internal
    {
        require(
            _requiredHarvest > 0,
        ...
        returns (uint256 _amount)
    {
        require(
            requiredHarvest[_strategy] > 0,
            "crv-strategy-keep3r::calculate-harvest:strategy-not-added"
        );
